...
- [No em dashes, no AI voice](no-em-dashes-no-ai-voice.md) — zero `—` and no generic AI marketing words, in deliverables and in chat.
- [Prospect demo workflow](prospect-demo-workflow.md) — how Souleman wins web clients, automated in the `prospect-site` skill.
- [Deliver as one HTML file](demo-delivery-single-html.md) — single self-contained file with inlined images, never a ZIP.
- [English default, French toggle](bilingual-en-default-fr-toggle.md) — bilingual standard for his Ottawa-area prospects, in Canadian French.
- [Stock photos: architectural, not medical](stock-photos-architectural-not-medical.md) — search interiors on StockSnap; rawpixel is watermarked.
- [Contexte de travail S-WEB](sweb-contexte-de-travail.md) : emploi de jour, fenêtres 12 h et 17 h, et trois vendeurs avec FM Media et Pose Ta Pierre.
...
- [Audit du chef de cabinet, 10 septembre 2026](chef-de-cabinet-audit-2026-09-10.md) : ce que proactif veut dire pour lui, les cartes retirees, le compte gh qui bascule, et les angles morts qui restent.
- [Construction de l'équipe](construction-equipe.md) : les sept sessions avant la phase 9, sessions 1 et 2 faites le 11 septembre 2026, ce que Souleman a tranche (PC, objectifs, WhatsApp, Opus), le plan dans `_Équipe/Construction de l'équipe.md`.
